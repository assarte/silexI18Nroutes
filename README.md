...
On redirection, SIR adding an `X-Sir-Redirection` HTTP header with value of `1` to the response, this could be checked on redirected target to be getting informed about the reason of redirection.
